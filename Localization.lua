...
-- CHANGES SHOULD BE MADE USING http://www.wowace.com/projects/inline-aura/localization/

local locale = GetLocale()
if locale == "frFR" then
L["Add spell"] = "Ajouter le sort"
L["Application count alignment"] = "Alignement du nombre de charges"
...
L["Enter the name of the spell for which you want to add specific settings. Spell names are checked against your spellbook."] = "Entrez le nom d'un sort pour lequel vous voulez ajouter des réglages spécifiques. Les noms sont vérifiés dans votre livre de sort."
...
L["One aura name per line. Name are used as provided so watch your spelling."] = "Un nom par ligne. Les noms sont utilisés tels quels donc vérifiez l'orthographe."
...
L["Select where the application count is displayed."] = "Sélectionnez de quel côté le nombre de charge est affiché."
...
L["%dm"] = "%dm"
L["Enter the name of the spell for which you want to add specific settings. Spell names are checked against your spellbook."] = "Den Namen des Zaubers eingeben für welchen du spezifische Einstellungen hinzufügen möchtest. Zaubernamen werden mit dem Zauberbuch verglichen."
...
L["Enter the name of the spell for which you want to add specific settings. Spell names are checked against your spellbook."] = "Введите название заклинания, к которому вы хотите добавить настройки. Названия заклинаний проверяются по вашей книге заклинаний"
...
L["Enter the name of the spell for which you want to add specific settings. Spell names are checked against your spellbook."] = "键入您想添加特殊设置的法术名称.法术名称请核对您的法术书."
L["Font name"] = "字体"
L["Inline Aura"] = "Inline Aura"
L["My buffs"] = "我的增益法术"
L["My debuffs"] = "我的减益法术"
...
L["No countdown"] = "无倒计时"
L["One aura name per line. Name are used as provided so watch your spelling."] = "每行一个光圈名称,名称被用来查看法术"
