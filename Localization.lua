...
L["Check to use the animated glow that is used for reactive abilities instead of coloring the button border."] = "Markieren, um das animierte Glänzen anzuwenden, das für reaktive Fähigkeiten verwendet wird, anstatt den Rand der Schaltfläche einzufärben."
...
L["Use animated glow"] = "Animiertes Glänzen anwenden"
