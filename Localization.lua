...
L["Dim"] = true
L["Display Inline Aura's glows out of combat. Uncheck to show them only during combats. Do not affect Blizzard built-in glows."] = true
...
L["Use a more accurate rounding, down to tenths of second, instead of the default Blizzard rounding."] = "使用更精確的四捨五入，下降到十分之二，用來取代Blizzard內建的四捨五入。" -- Needs review
