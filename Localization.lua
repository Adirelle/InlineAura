...
L["Check to use the animated glow that is used for reactive abilities instead of coloring the button border."] = true
...
L["Check to use the animated glow that is used for reactive abilities instead of coloring the button border."] = "Cochez ceci pour utiliser la surbrillance animée (celle des techniques réactives) plutôt que de colorer le bord du bouton."
...
L["Use animated glow"] = "Surbrillance animée"
...
L["Aura type"] = "Auratyp"
L["Auras to look up"] = "Auras anzeigen"
...
L["Check to hide the aura application count (charges or stacks)."] = "Überprüfung zum verstecken des Auracountdowns"
L["Check to hide the aura countdown."] = "Überprüfung zum verstecken des Auracountdowns"
L["Check to hide the aura duration countdown."] = "Auswahl zum verstecken des Auracooldowns. "
L["Check to ignore buffs cast by other characters."] = "Überprüfung zum Ignorieren der gecasteten Buffs anderer Charaktere"
...
L["Do you really want to remove these aura specific settings ?"] = "Wollen sie wirklich diese spezifischen Auraeinstellungen löschen ?"
...
L["Friendly focus"] = "Befreundeter Focus"
L["Friendly target"] = "Befreundetes Target"
L["Hostile focus"] = "Feindlicher Focus"
L["Hostile target"] = "Feindliches Target"
L["Inline Aura"] = "Inline Aura"
L["Left"] = "Links"
...
L["Others' buffs"] = "Andere Buffs"
L["Others' debuffs"] = "Andere Debuffs"
L["Pet"] = "Pet"
L["Player"] = "Spieler"
...
L["Select the color to use for the debuffs you cast."] = "Auswahl der Farbe für die eigenen gecasteten Debuffs"
...
L["Select where to place a single value."] = "Auswahl, wo ein Wert platziert werden soll. "
...
L["Single value position"] = "Position eines Wertes. "
...
L["Spell to edit"] = "Zauber zum Editieren"
...
L["Font name"] = "字型名字"
L["Friendly focus"] = "友好焦點"
L["Friendly target"] = "友善目標"
L["Hostile focus"] = "敵方焦點"
L["Hostile target"] = "敵方目標"
L["Inline Aura"] = "Inline Aura"
L["Left"] = "左"
L["My buffs"] = "我的增益法術"
L["My debuffs"] = "我的減益法術"
