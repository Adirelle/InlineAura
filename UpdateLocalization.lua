...
for line in io.lines() do
	...
	if project then
		...
		io.write("-- CHANGES SHOULD BE MADE USING http://www.wowace.com/projects/"..project.."/localization/\n\n")
		local url = ("http://www.wowace.com/projects/%s/localization/export.txt"):format(project)
		local params = {
			namespace = '',
